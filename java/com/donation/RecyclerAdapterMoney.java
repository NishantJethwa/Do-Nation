...
public class RecyclerAdapterMoney extends RecyclerView.Adapter<RecyclerAdapterMoney.ViewHolder> {

    private Context context;
    private List<TextUtils> personUtils;
    static int count;

    public RecyclerAdapterMoney(Context context, List personUtils) {
