...
public class RecyclerAdapter1 extends RecyclerView.Adapter<RecyclerAdapter1.ViewHolder> {
    ...
    public RecyclerAdapter1(Context context, List personUtils) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(cpu.getText1() == "Share At Doorstep India") {
                        ...
                        Intent intent=new Intent(view.getContext(), RecyclerAdapter1.class);
                    ...
                    if(cpu.getText1() == "Sneha Sadan") {
                        ...
                        //Get the SmsManager instance and call the sendTextMessage method to send message
                        SmsManager sms=SmsManager.getDefault();
                        sms.sendTextMessage(number, null, "https://docs.google.com/forms/d/e/1FAIpQLScKARDGiA9IMjm9JFjcauOZ8vdAnCD9nHCmwFZVa2MGuxdZ0Q/viewform?usp=sf_link", pi,null);
                    ...
                    if(cpu.getText1() == "Wishing Well") {
                        ...
                        //Get the SmsManager instance and call the sendTextMessage method to send message
                        SmsManager sms=SmsManager.getDefault();
                        sms.sendTextMessage(number, null, "https://docs.google.com/forms/d/e/1FAIpQLSdrzyTtzfRsHJhCqV_XbP5u-6Yx8VfrsIVo5hVjbe7DtryYAA/viewform?usp=sf_link", pi,null);
                    ...
                    if(cpu.getText1() == "Goonj") {
                        ...
                        //Get the SmsManager instance and call the sendTextMessage method to send message
                        SmsManager sms=SmsManager.getDefault();
                        sms.sendTextMessage(number, null, "https://docs.google.com/forms/d/e/1FAIpQLSeHsMK5BOjWLYq8mAxGmDE0mEn9NaV8Q9w1-CASiIItB4BqZA/viewform?usp=sf_link", pi,null);
                    ...
                    if(cpu.getText1() == "Green Yatra") {
                        ...
                        //Get the SmsManager instance and call the sendTextMessage method to send message
                        SmsManager sms=SmsManager.getDefault();
                        sms.sendTextMessage(number, null, "https://www.google.com/", pi,null);
